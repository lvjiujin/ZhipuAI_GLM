...
MODEL_PATH = os.environ.get('MODEL_PATH', '/home/featurize/work/ZhipuAI_GLM/ChatGLM3/fine-tune/models/advertisegen/THUDM/chatglm3-6b')
...
with gr.Blocks() as demo:
    gr.HTML("""<h1 align="center">ChatGLM3-6B qloara finetune on AdvertiseGen </h1>""")
    chatbot = gr.Chatbot()
